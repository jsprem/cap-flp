...
const tableName = 'RAG_CONTRACTS_DEMO_DOCUMENTCHUNK';
...
module.exports = function () {
    ...
    this.on('getChatRagResponse', async (req) => {
        try {
            ...
            */
            console.log("Getting the RAG retrieval response from the CAP LLM Plugin!");
            ...
            {
                throw new Error("The model supported in this application is 'gpt-35-turbo'. Please customize this application to use any model supported by CAP LLM Plugin. Please make the customization by referring to the comments.")
            }
