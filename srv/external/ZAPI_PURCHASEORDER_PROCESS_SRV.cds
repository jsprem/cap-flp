/* checksum : 8f4a6425cc5d8a83574ae3efe3d7e95d */
@cds.external : true
...
entity ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrder {
  ...
  to_PurchaseOrderNote : Composition of many ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderNote {  };
};
...
entity ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderItem {
  ...
  to_AccountAssignment : Composition of many ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurOrdAccountAssignment {  };
  to_PurchaseOrderItemNote : Composition of many ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderItemNote {  };
  to_PurchaseOrderPricingElement : Composition of many ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurOrdPricingElement {  };
  to_ScheduleLine : Composition of many ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderScheduleLine {  };
};
...
entity ZAPI_PURCHASEORDER_PROCESS_SRV.A_PurchaseOrderScheduleLine {
  ...
  to_SubcontractingComponent : Composition of many ZAPI_PURCHASEORDER_PROCESS_SRV.A_POSubcontractingComponent {  };
};
